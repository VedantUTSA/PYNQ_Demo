...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../PYNQ.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../PYNQ.gen/sources_1/bd/design_1/ipshared/3007/hdl" \
       +incdir+"../../../../PYNQ.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../PYNQ.gen/sources_1/bd/design_1/ipshared/3007/hdl" \
       +incdir+"D:/Vivado/2021.2/data/xilinx_vip/include"
}
